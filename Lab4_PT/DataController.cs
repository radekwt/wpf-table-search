...
namespace Lab4_PT
{
    class DataController
    {
        ...
        {
            myCarsBindingList.Sort("model", System.ComponentModel.ListSortDirection.Descending);
            OutputWriter.WriteEmptyLine();
            OutputWriter.Write("myCars sorted by model DSC");
